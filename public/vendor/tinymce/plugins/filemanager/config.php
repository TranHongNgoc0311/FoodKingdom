...
$upload_dir = '/storage/app/public/uploads/files/'; // path from base_url to upload base dir
$current_path = '../../../../../../storage/app/public/uploads/files/'; // relative path from filemanager folder to upload files folder
