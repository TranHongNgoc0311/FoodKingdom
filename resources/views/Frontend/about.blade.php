    ...
    <div class="container">
      <div class="row slider-text justify-content-center align-items-center">
        ...
        <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('home')}}">Trang chủ</a></span> <span>Giới thiệu</span></p>
        </div>
...
<div class="row">
    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        <div class="staff">
            <div class="img mb-4" style="background-image: url({{url('public/images/person_1.jpg')}});"></div>
    ...
    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        <div class="staff">
            <div class="img mb-4" style="background-image: url({{url('public/images/person_2.jpg')}});"></div>
            <div class="info text-center">
    ...
    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        <div class="staff">
            <div class="img mb-4" style="background-image: url({{url('public/images/person_3.jpg')}});"></div>
            <div class="info text-center">
    ...
    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        <div class="staff">
            <div class="img mb-4" style="background-image: url({{url('public/images/person_4.jpg')}});"></div>
            <div class="info text-center">
